...
void mouseClicked() {
 ...
 System.out.println("fire");
      ...
      intercept.setXvel(rocket.getXvel() + (rocket.getXinit()-intercept.getXinit())/((millis()-timeOffset)/1000)/10);//v0x1 + (s0x1-s0x2)/t = v0x2
      intercept.setYvel(rocket.getYvel() + (rocket.getXinit()-intercept.getXinit())/((millis()-timeOffset)/1000)*5);//v0x1 + (s0x1-s0x2)/t = v0x2
